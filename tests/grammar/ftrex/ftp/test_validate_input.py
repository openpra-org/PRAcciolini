...
class TestValidateInputFtrexFtp(unittest.TestCase):
    ...
    def test_valid_input(self):
        ...
        """
        valid_schema_path = self.fixtures_path / 'valid'
    ...
    def test_valid_parsing(self):
        file_path = self.fixtures_path / 'valid' / 'fragment' / 'tree.ftp'
        self.assertTrue(validate_ftp_file(file_path), f'File {file_path} should be valid.')
